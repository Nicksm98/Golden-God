    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-6 max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4 text-gray-700">
          <div className="text-lg font-semibold mb-4">Card Deck Rules</div>
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="grid grid-cols-[auto_1fr] gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all items-center">
              ...
              <div className="text-sm text-gray-600">
                Because of your tiny hands, you may opt in to take a smaller
                drink when you&apos;re given one. You may use this action 3 times
                during the game and must admit &quot;My hands are too tiny for a
                big boy cup&quot;. You may continue to try using this tactic but
                if anyone kept count and calls you out, drink double.
              </div>
            </div>
            ...
            <div className="grid grid-cols-[auto_1fr] gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all items-center">
              ...
              <div className="text-sm text-gray-600">
                Categories - The player who draws this card picks a category
                and says a word that fits. Going around, each player must
                say a unique word from that category. If a player hesitates,
                repeats a word, or can&apos;t give a valid answer, they
                drink
              </div>
            </div>
            ...
            <div className="grid grid-cols-[auto_1fr] gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all items-center">
              ...
              <div className="text-sm text-gray-600">Me - Drink.</div>
            </div>
